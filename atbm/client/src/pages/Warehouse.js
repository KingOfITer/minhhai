...
function Warehouse () {
  ...
  return (
    <div style={{display:'flex', justifyContent:'center',marginTop:'5%', flexDirection: 'column', marginLeft: '40%'}}>
      <Table responsive className="table-border-bottom">
        <thead>
          <tr style={{ display: 'flex', alignItems: 'center' }}>
            <th>
            <Form>
              <div style={{ marginRight: '50px' }} key="default-checkbox" className="mb-3">
                <Form.Check
                  type="checkbox"
                  id="default-checkbox"
                  label="All"
            ...
            <DropdownButton id="dropdown-basic-button" title="" >
              <Dropdown.Item href="#/action-1">Di chuyển mục đã chọn</Dropdown.Item>
